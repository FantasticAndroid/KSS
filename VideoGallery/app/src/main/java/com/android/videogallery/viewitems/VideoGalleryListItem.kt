...
class VideoGalleryListItem(
...
) : AdapterItem<VideoGalleryListItem.Holder>() {
    private var videoGallery: VideoGallery? = null

    override fun getLayoutId(): Int {
        return if (layoutType === LayoutType.VIDEO_GALLERY_RVL) R.layout.item_video_gallery_list else if (layoutType === LayoutType.VIDEO_GALLERY_RVG) {
            R.layout.item_video_gallery_grid
        } else if (layoutType === LayoutType.VIDEO_GALLERY_RVH) R.layout.item_video_gallery_horizontal_fill else R.layout.item_video_gallery_list
    }
    ...
    inner class Holder(view: View, adapter: RecyclerAdapterNotifier?) :
